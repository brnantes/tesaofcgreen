...
-- Primeiro, vamos limpar qualquer dado de torneio duplicado
DELETE FROM site_content WHERE type = 'tournament';

-- Agora vamos inserir os torneios de exemplo com dados corretos

...
-- Primeiro, vamos garantir que a tabela site_content existe com a estrutura correta
...
-- Limpar dados antigos de torneios se existirem
DELETE FROM public.site_content WHERE type = 'tournament';

-- Inserir os torneios com datas atualizadas para a semana atual
...
SELECT COUNT(*) as total_torneios FROM public.site_content WHERE type = 'tournament';

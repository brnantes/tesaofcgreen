...
-- First, let's check if there are any tournament records
SELECT * FROM public.site_content WHERE type = 'tournament';

-- If no records exist, let's insert the example tournaments
